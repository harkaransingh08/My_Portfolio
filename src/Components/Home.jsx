...
export default function Home() {
  ...
  const text = `I’m a developer who enjoys building clean, interactive web experiences and learning how things work under the hood. I work primarily with React, Tailwind CSS, and modern JavaScript, and I like combining smooth UI animations with solid logic.
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        variants={shouldReduceMotion ? undefined : typingText}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      >
